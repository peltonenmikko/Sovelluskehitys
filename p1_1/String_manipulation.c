...
int main(void)
{
    ...
    char str[STR_LENGTH] = "new string";
    char cmd;
    menu();
...
/*********************************************************************
 NAME: current
 DESCRIPTION: Prints the current string to terminal
	Input: string
	Output: none
  Used global variables: none
 REMARKS when using this function:
...
/*********************************************************************
 ...
 DESCRIPTION: Asks the user to give new string that will replace the old one
	Input: string
	Output: new string
  Used global variables: STR_LENGTH
 REMARKS when using this function:
*********************************************************************/
...
/*********************************************************************
 NAME: read_file
 DESCRIPTION: Prints the string saved to textfile.txt into the terminal
	Input: string
	Output: none
  Used global variables: STR_LENGTH
 REMARKS when using this function:
...
void read_file(char str[])
{
    ...
    if(file_pointer==0)
        ...
        {
            fgets(str, STR_LENGTH, file_pointer);
            printf("%s",str);
            fclose(file_pointer);
        }
}
